...
<ul>
  ...
  // ── 73. 강아지 배변훈련 (guide, cat.1) ─────────────────────────────────────
  {
    id: "seed-guide-puppy-potty-training",
    slug: "puppy-potty-training",
    type: "guide",
    category: 1,
    title: "강아지 배변훈련 완전 가이드 — 퍼피부터 성견까지 단계별 방법",
    metaTitle: "강아지 배변훈련 방법·기간·실패 대처법 | 펫지기",
    metaDescription:
      "강아지 배변훈련 성공 비결: 퍼피 기초 훈련부터 실내·실외 전환, 실수 대처법, 훈련 기간 단축 팁까지 단계별로 안내합니다.",
    body: `<h2>배변훈련, 언제 시작할까?</h2>
<p>생후 8주 이후부터 시작할 수 있습니다. 근육 조절 능력은 생후 16~20주 정도에 완성되므로, 이 시기 이전에는 실수가 잦더라도 정상입니다. 인내심 있는 반복 훈련이 핵심입니다.</p>

<h2>기본 원칙</h2>
<ul>
  <li><strong>즉각 칭찬</strong>: 올바른 장소에서 배변하면 즉시 (3초 이내) 칭찬·간식 보상</li>
  <li><strong>실수 시 체벌 금지</strong>: 체벌은 불안감을 높여 훈련을 방해함 — 조용히 치우기</li>
  <li><strong>일관성</strong>: 모든 가족이 같은 방법과 명령어를 사용</li>
  <li><strong>규칙적인 일과</strong>: 식사·수면·놀이 후 15~20분 내 배변 유도</li>
</ul>

<h2>실내 패드 훈련 (단계별)</h2>
<ol>
  <li><strong>패드 위치 결정</strong>: 조용하고 눈에 잘 보이는 한 장소에 고정</li>
  <li><strong>타이밍 포착</strong>: 강아지가 냄새를 맡거나 빙빙 돌면 패드로 유도</li>
  <li><strong>명령어 연결</strong>: 패드 위에서 배변하는 동안 "쉬야" 또는 "응가"를 부드럽게 말함</li>
  <li><strong>즉시 보상</strong>: 배변 완료 직후 칭찬 + 간식</li>
  <li><strong>점진적 패드 축소</strong>: 훈련이 익숙해지면 패드 수를 줄여 배변 장소 고정</li>
</ol>

<h2>실외 배변 훈련으로 전환</h2>
<ul>
  <li>예방접종 완료(생후 약 16주) 후 실외 훈련 시작 권장</li>
  <li>매일 같은 시간, 같은 장소로 산책 — 냄새가 배변 욕구 자극</li>
  <li>야외에서 배변 성공 시 실내 패드 점진적으로 제거</li>
</ul>

<h2>배변 주기 관리 (퍼피 기준)</h2>
<ul>
  <li>식사 후 15~30분 내</li>
  <li>수면 후 즉시</li>
  <li>놀이 중·후</li>
  <li>생후 월령 × 1시간이 최대 참는 시간의 대략적 기준 (예: 3개월 = 약 3시간)</li>
</ul>

<h2>자주 실수하는 장소 대처법</h2>
<ul>
  <li>효소 기반 전용 세정제로 완전히 냄새 제거 — 잔여 냄새는 재실수 유발</li>
  <li>같은 장소에 패드를 잠시 놓아 배변 장소로 재인식시키거나, 접근을 차단</li>
</ul>

<h2>훈련이 잘 안 될 때 점검 사항</h2>
<ul>
  <li>보상 타이밍이 늦지 않은지 (배변 후 즉시 보상)</li>
  <li>패드 위치가 자주 바뀌지 않는지</li>
  <li>건강 문제(요로감염·소화 불량)로 인한 잦은 실수 여부 — 지속 시 수의사 상담</li>
</ul>`,
    disclaimer: null,
    sources: [
      "Reid PJ. Excel-erated Learning: Explaining in Plain English How Dogs Learn. James & Kenneth (1996)",
      "한국반려동물행동상담사협회 퍼피 훈련 가이드 (2022)",
    ],
    ymyl: false,
    status: "published",
    publishedAt: "2026-05-22T00:00:00.000Z",
  ...
  // ── 74. 노령 강아지 영양·사료 가이드 (guide, cat.2) ──────────────────────
  {
    id: "seed-guide-senior-dog-nutrition",
    slug: "senior-dog-nutrition-guide",
    type: "guide",
    category: 2,
    title: "노령 강아지 영양·사료 가이드 — 7세 이후 식이 관리",
    metaTitle: "노령 강아지 사료 선택·영양 관리 | 7세 이후 식이 | 펫지기",
    metaDescription:
      "노령 강아지(7세 이상)의 달라지는 영양 요구, 시니어 사료 선택 기준, 관절·신장·치아를 고려한 식이 관리법을 수의사 검토를 거쳐 안내합니다.",
    body: `<h2>강아지는 몇 살부터 노령견?</h2>
<p>일반적으로 소형견 10~12세, 중형견 8~10세, 대형·초대형견 7~8세부터 노령기로 분류합니다. 하지만 품종과 건강 상태에 따라 노화 속도가 다릅니다. 시니어 사료로 전환 시기는 수의사와 상의하세요.</p>

<h2>노령 강아지의 달라지는 영양 요구</h2>
<ul>
  <li><strong>칼로리 감소</strong>: 신진대사 저하·활동량 감소로 성견 대비 20~30% 칼로리 낮춰야 함</li>
  <li><strong>단백질 유지 또는 증가</strong>: 근육 유지를 위해 고품질 단백질 필요 (노령=저단백이라는 오해 주의)</li>
  <li><strong>인·나트륨 제한</strong>: 신장 기능 저하 시 인 과잉은 신부전 가속 — 신장 질환이 없는 경우 큰 제한 불필요</li>
  <li><strong>오메가-3 지방산</strong>: 관절 염증 감소, 인지 기능 지원 (EPA·DHA 함량 확인)</li>
  <li><strong>식이섬유 증가</strong>: 장 운동 저하 예방 — 프리바이오틱스 포함 사료 유리</li>
</ul>

<h2>시니어 사료 선택 기준</h2>
<ul>
  <li>✓ <strong>AAFCO/FEDIAF 성견 유지 기준 충족</strong> 또는 시니어 전용 기준 표기</li>
  <li>✓ <strong>칼로리 밀도 낮음</strong>: 체중 관리를 위해 kcal/kg 확인</li>
  <li>✓ <strong>첫 번째 원료가 동물성 단백질</strong>: 닭고기·연어·소고기 등</li>
  <li>✓ <strong>글루코사민·콘드로이틴 포함</strong>: 관절 건강 지원</li>
  <li>✓ <strong>항산화제(비타민 E·C, 베타카로텐)</strong>: 노화 관련 산화 스트레스 감소</li>
  <li>✓ <strong>습식 성분 활용</strong>: 치아·신장 문제 있는 경우 습식 병행 권장</li>
</ul>

<h2>급여량 조정 방법</h2>
<ul>
  <li>현재 체중과 이상 체중 기준으로 포장지 급여량 참고</li>
  <li>체중이 줄거나 늘면 즉시 급여량 조정</li>
  <li>하루 2~3회로 나눠 급여 — 소화 부담 감소</li>
  <li>식욕 급감 또는 체중 변화가 빠르면 수의사 검진</li>
</ul>

<h2>주의 음식 및 보충제</h2>
<ul>
  <li>노령견에게 특히 위험: 고나트륨 음식, 고지방 음식 (췌장염 위험)</li>
  <li>오메가-3 보충제(피쉬오일)는 DHA·EPA 함량 확인 후 사용 — 수의사 권장량 준수</li>
  <li>관절 보충제(글루코사민·콘드로이틴)는 과학적 근거 있음 — 수의사 상담 후 시작</li>
</ul>`,
    disclaimer:
      "본 정보는 일반적인 영양 가이드이며 특정 질환을 가진 강아지의 식이 처방을 대체하지 않습니다. 신장·간·당뇨 질환이 있는 경우 반드시 수의사 처방 사료를 이용하세요.",
    sources: [
      "AAFCO (Association of American Feed Control Officials) — Senior Dog Nutrition Guidelines (2023)",
      "Freeman LM et al. Current knowledge about the risks and benefits of raw meat-based diets for dogs. JAVMA (2013)",
      "대한수의사회 소동물 영양 임상 가이드 (2022)",
    ],
    ymyl: true,
    status: "published",
    publishedAt: "2026-05-22T00:00:00.000Z",
  ...
  // ── 75. 펫보험 면책 사항 가이드 (guide, cat.4, YMYL) ─────────────────────
  {
    id: "seed-guide-pet-insurance-exclusions",
    slug: "pet-insurance-exclusions",
    type: "guide",
    category: 4,
    title: "펫보험 면책 사항 완전 정복 — 보장 안 되는 항목과 절약 전략",
    metaTitle: "펫보험 면책 사항·보장 제외 항목 총정리 | 펫지기",
    metaDescription:
      "펫보험이 보장하지 않는 면책 사항(선천성 질환·미용·치과 치료 등)과 면책 기간 적용 기준, 보험금 지급 거절 사례 예방법을 정리했습니다.",
    body: `<h2>펫보험 면책(보장 제외) 이란?</h2>
<p>보험 계약 약관에서 명시적으로 보상 대상에서 제외하는 항목입니다. 가입 전 면책 항목을 정확히 파악해야 추후 보험금 지급 거절로 인한 분쟁을 예방할 수 있습니다.</p>

<h2>일반적으로 보장되지 않는 항목</h2>
<h3>선천성·유전성 질환</h3>
<p>품종 특유의 유전 질환(예: 말티즈의 수두증, 불독의 단두증 호흡기 문제)은 대부분 면책 또는 특약 추가 시에만 보장합니다. 일부 보험사는 가입 후 1년 이내 발병한 유전성 질환을 면책으로 처리하기도 합니다.</p>

<h3>예방 처치</h3>
<ul>
  <li>정기 예방접종·심장사상충 예방약</li>
  <li>중성화 수술 (일부 보험사는 특약으로 보장)</li>
  <li>정기 건강검진 비용</li>
</ul>

<h3>미용·위생 처치</h3>
<ul>
  <li>목욕·클리핑 등 미용 비용</li>
  <li>항문낭 일상 짜기</li>
  <li>발톱 관리</li>
</ul>
...
<h3>치과 치료 (조건부)</h3>
<ul>
  <li>스케일링·치석 제거 (예방 목적)</li>
  <li>일부 보험사는 발치·치주질환 치료를 특약으로 보장</li>
</ul>

<h3>면책 기간</h3>
<ul>
  <li>통상 가입 후 <strong>30일</strong>간 보장 제외 (보험사별 상이)</li>
  <li>수술은 <strong>90일</strong> 면책 적용하는 경우 많음</li>
  <li>암·종양은 가입 후 180일 면책 적용 상품도 있음</li>
</ul>

<h2>보험금 지급 거절 주요 사례</h2>
<ul>
  <li><strong>고지 의무 위반</strong>: 가입 시 기존 질환·치료 이력 미고지 → 계약 해지 가능</li>
  <li><strong>면책 기간 내 청구</strong>: 가입 직후 발병한 질환</li>
  <li><strong>처방전 없는 약품 구매</strong>: 영수증만으로 청구 시 처방전 필요</li>
  <li><strong>비급여 항목</strong>: 한방치료·보완 의학 등 약관에 없는 항목</li>
</ul>

<h2>보험금 최대화 전략</h2>
<ul>
  <li><strong>동물병원 진료 기록 보관</strong>: 진단서·처방전·영수증 모두 보관</li>
  <li><strong>가입 전 고지 성실히</strong>: 기존 병력을 숨기면 계약 무효 위험</li>
  <li><strong>특약 활용</strong>: 치과·유전성 질환 등 필요한 특약 추가</li>
  <li><strong>청구 기한 준수</strong>: 보통 치료 후 90일 또는 1년 이내</li>
</ul>

<h2>보험사별 비교 시 확인 포인트</h2>
<ul>
  <li>면책 기간 (30일? 90일?)</li>
  <li>선천성 질환 보장 여부</li>
  <li>치과 치료 특약 포함 여부</li>
  <li>갱신 거절 조건</li>
</ul>`,
    disclaimer:
      "본 정보는 일반적인 안내 목적이며 특정 보험 상품의 약관 해석이나 보험금 지급 보장을 의미하지 않습니다. 가입 전 각 보험사 약관을 반드시 직접 확인하세요. 보험 분쟁은 금융감독원(☎ 1332) 또는 한국소비자원(☎ 1372)에 문의하세요.",
    sources: [
      "금융감독원 반려동물보험 비교공시 (2024)",
      "한국소비자원 펫보험 분쟁 사례 분석 (2023)",
      "보험소비자연맹 펫보험 약관 비교 리포트 (2024)",
    ],
    ymyl: true,
    status: "published",
    publishedAt: "2026-05-22T00:00:00.000Z",
