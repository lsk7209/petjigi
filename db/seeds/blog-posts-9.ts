...
<p>야간·주말에는 24시간 응급 동물병원을 미리 파악해 두는 것이 중요하다. 강아지에게 위험한 식재료 전체 목록은 <a href="/blog/dog-toxic-foods">강아지 먹으면 안 되는 음식</a>에서 확인할 수 있다. 구토가 이미 있거나 다른 위장 증상이 있다면 <a href="/blog/dog-vomiting-when-to-vet">강아지 갑자기 구토 — 병원 가야 할 신호</a>도 함께 읽어두자.</p>`,
   ...
   * ══════════════════════════════════════════════════════════════════ */
  {
    ...
    body: `<p>한때 FIP(Feline Infectious Peritonitis, 고양이 전염성 복막염)는 진단 후 거의 예외 없이 치명적인 결과로 이어지던 질환이었다. 그러나 Journal of Feline Medicine and Surgery(2019)에 실린 연구에서 항바이러스제 GS-441524 투여 그룹의 FIP 고양이 80% 이상에서 임상적 관해가 나타났다. 최신 정보를 알고 있으면 포기하지 않아도 되는 상황이 생긴다.</p>

<h2>FIP란 무엇인가</h2>
<p>FIP는 고양이 코로나바이러스(FCoV)의 변이 형태가 원인이다. 대부분의 고양이는 FCoV에 감염돼도 가벼운 장염 증상만 보이지만, 일부에서 바이러스가 돌연변이를 일으켜 면역계를 공격하는 FIP로 발전한다. Cornell Feline Health Center에 따르면 5세 미만 고양이, 특히 다묘 환경의 2세 미만 어린 고양이에서 발생률이 높다.</p>
...
<p>항바이러스제 GS-441524와 GC376은 FIP에 대한 치료 효과가 임상 연구에서 확인됐다. 현재 한국에서는 정식 허가 여부와 처방 가능 여부가 변화하고 있으므로, 반드시 수의사와 최신 현황을 상의해야 한다. FIP 치료 경험이 풍부한 대학 동물병원을 찾는 것이 도움이 된다.</p>

<h2>진단의 어려움과 비용 대비</h2>
<p>FIP는 확진이 어렵다. 혈액 AGP(혈청 단백질), A:G 비율, 삼출액 분석, PCR 검사, 조직검사를 종합해 진단한다. 치료비 부담이 크므로 <a href="/insurance/compare">펫보험</a>으로 사전 대비를 해두자. 면역 관련 고양이 질환인 <a href="/blog/cat-felv-guide">FeLV(백혈병 바이러스) 가이드</a>도 함께 알아두면 도움이 된다.</p>`,
    ymyl: true,
    disclaimer: YMYL_DISCLAIMER,
    status: "published",
