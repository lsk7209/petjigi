...
<ul>
  <li><strong>완전 접종 전 공공장소 바닥 접촉 금지</strong>: AVMA에 따르면 파보바이러스는 환경에서 수개월~1년까지 생존하며, 생후 16주 이전 미접종 강아지의 감염 시 예후가 매우 불량하다. 생후 16주 이전까지는 공원·펫숍·동물병원 대기실 바닥과의 직접 접촉을 최소화한다</li>
